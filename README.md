...
## 🔗 Live Links
- Frontend (User App): [https://your-frontend-link](https://whimsy-frontend.vercel.app/)
...
- Admin Panel: [https://github.com/shiven24k/whimsy-admin](https://github.com/shiven24k/whimsy-admin)
- Backend API: [https://github.com/shiven24ke/whimsy-api](https://github.com/shiven24k/whimsy-backend)

## ⚙️ Features
- Authentication (JWT)
- Product & Inventory Management
- Order Processing (COD, Stripe, Razorpay)
- Admin Dashboard for full control
- Email notifications (Nodemailer)

## 🧱 Tech Stack
React, Node.js, Express, MongoDB, Stripe, Razorpay, Cloudinary
